      ...
      <ScrollView>
        <View
          ...
          <View style={{padding: '2%'}}>
            <Text style={{color: '#b7b7b7', fontSize: hp('2%')}}>Biomes</Text>
            <Text style={{color: '#b7b7b7', fontSize: hp('2%')}}>Weather</Text>
            <Text style={{color: '#b7b7b7', fontSize: hp('2%')}}>Sentinels</Text>
          </View>
        </View>
